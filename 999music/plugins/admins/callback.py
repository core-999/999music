...
from 999music.misc import SUDOERS, db
...
from 999music.utils.decorators import ActualAdminCB, languageCB
from 999music.utils.formatters import seconds_to_min, time_to_seconds
from 999music.utils.inline import close_markup
from 999music.utils.inline.play import colored_stream_markup, colored_stream_markup_timer, generate_progress_bar
...
async def _now_playing_timer():
    ...
    """
    from 999music.utils.inline.play import UPDATE_INTERVAL, should_update_progress
    while True:
