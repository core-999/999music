...
from 999music.utils.decorator import admin_required
from 999music.utils.permissions import mention, extract_user_and_reason
...
@app.on_message(filters.regex(r"(?i)^(hi|hello|hey|bot)\b") & filters.text & filters.group, group=-99)
async def chatbot_handler(client, message: Message):
    replies = [
        "Hello! 👋", "Hi there!", "Hey! How can I help?",
        "What's up?", "Yo!", "Hi, how are you?", "အေးပြောလေ သီချင်းနားထောင်မှာလား ဖွင့်လေ",
    ]
