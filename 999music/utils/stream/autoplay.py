...
import config
from 999music import LOGGER, app
from 999music.core.mongo import mongodb
from 999music.misc import db
from 999music.platforms.Youtube import YouTubeAPI, youtube_search_multi
...
async def auto_play_next(
    ...
    """
    from 999music.utils.database import get_lang
    ...
    try:
        ...
        from 999music.utils.database import is_active_chat as _verify_stream_active
        ...
        try:
            ...
            from 999music.utils.database import is_on_off
