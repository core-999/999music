...
from 999music.utils.cookie_handler import COOKIE_PATH
from 999music.utils.database import is_on_off
from 999music.utils.downloader import download_audio_concurrent, yt_dlp_download
from 999music.utils.errors import capture_internal_err
from 999music.utils.formatters import time_to_seconds
from 999music.utils.tuning import (
    YTDLP_TIMEOUT,
    YOUTUBE_META_MAX,
    YOUTUBE_META_TTL,
)
from 999music import LOGGER
...
async def load_apis():
    ...
    logger = LOGGER("999music.platforms.Youtube.py")
